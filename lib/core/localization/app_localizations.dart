...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'save_search_hint': 'Save this query and refinements',
      'saved_searches': 'Saved searches',
      'apply_saved_search': 'Apply saved search',
      'rename_saved_search': 'Rename saved search',
      ...
      'saved_search_applied': 'Saved search applied',
      'saved_search_highlights': 'Saved search highlights',
      'saved_search_quick_title': 'Your saved alerts',
      'saved_search_new_badge': '%d new',
      'saved_search_total_label': '%d matches',
      'saved_search_preview_button': 'View results',
      'saved_search_preview_empty': 'No matches yet',
      'saved_search_manage': 'Manage',
      'saved_search_applied_with_new': 'Saved search applied – %d new matches',
      'saved_search_notification_title': 'New matches in "%s"',
      'saved_search_notification_subtitle': '%d listings waiting',
      'saved_search_notification_preview': 'Latest: %s',
      'save_search_placeholder': 'Name your search',
      'save_search_required': 'Enter a name',
      'search_results_count': 'Showing %d results',
      'clear_search': 'Clear search',
      'refine_results': 'Refine results',
      'matching_cities': 'Matching cities',
      'matching_tags': 'Popular tags',
      'active_refinements': 'Active refinements: %d',
      'clear_refinements': 'Clear refinements',
      ...
      'booking_select_slot': 'Pick a time slot to confirm.',
      ...
      'section_recommended': 'Featured picks',
    ...
    'ar': {
      ...
      'save_search': 'احفظ البحث',
      'save_search_hint': 'احفظ هذا البحث والتخصيصات',
      'saved_searches': 'عمليات البحث المحفوظة',
      'apply_saved_search': 'تطبيق البحث المحفوظ',
      'rename_saved_search': 'إعادة تسمية البحث المحفوظ',
      ...
      'saved_search_applied': 'تم تطبيق البحث المحفوظ',
      'saved_search_highlights': 'أبرز عمليات البحث المحفوظة',
      'saved_search_quick_title': 'تنبيهاتك المحفوظة',
      'saved_search_new_badge': '%d نتائج جديدة',
      'saved_search_total_label': '%d نتيجة',
      'saved_search_preview_button': 'عرض النتائج',
      'saved_search_preview_empty': 'لا توجد نتائج بعد',
      'saved_search_manage': 'إدارة',
      'saved_search_applied_with_new': 'تم تطبيق البحث المحفوظ – %d عقارات جديدة',
      'saved_search_notification_title': 'عقارات جديدة في "%s"',
      'saved_search_notification_subtitle': '%d عقار بانتظارك',
      'saved_search_notification_preview': 'الأحدث: %s',
      'save_search_placeholder': 'أدخل اسم البحث',
      'save_search_required': 'أدخل اسمًا',
      'search_results_count': 'عرض %d نتيجة',
      'clear_search': 'مسح البحث',
      'refine_results': 'تنقية النتائج',
      'matching_cities': 'مدن مطابقة',
      'matching_tags': 'وسوم شائعة',
      'active_refinements': 'التنقيحات المفعلة: %d',
      'clear_refinements': 'مسح التنقيحات',
      'best_offer': 'أفضل عرض',
      'for_sale': 'للبيع',
      'for_rent': 'للإيجار',
      ...
      'booking_select_slot': 'يرجى اختيار وقت الزيارة قبل التأكيد.',
      ...
      'greeting_guest': 'ضيف',
      'section_recommended': 'عقارات مميزة',
