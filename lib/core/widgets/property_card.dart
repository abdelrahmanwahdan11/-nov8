              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    runSpacing: 8,
                    children: [
                      _FacilityChip(label: '${property.facilities.beds} bd'),
                      _FacilityChip(label: '${property.facilities.baths} ba'),
                    ...
                    children: [
                      ...
                      if (property.mortgageEligible)
                        Container(
                          ...
                          child: Text('Mortgage', style: theme.textTheme.labelMedium?.copyWith(color: accent)),
                        ),
                    ],
                  ),
                  const SizedBox(height: 12),
