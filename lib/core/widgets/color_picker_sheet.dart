    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSlider('Hue', _hue, 0, 360, (value) => setState(() => _hue = value)),
          _buildSlider('Saturation', _saturation, 0, 1, (value) => setState(() => _saturation = value)),
          _buildSlider('Lightness', _lightness, 0, 1, (value) => setState(() => _lightness = value)),
