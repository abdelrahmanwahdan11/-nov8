...
class _MyItemsPageState extends State<MyItemsPage> {
  String _statusLabel(AppLocalizations l10n, String status) {
    switch (status) {
      case 'waiting_offers':
        return l10n.t('status_waiting');
      case 'reviewing':
        return l10n.t('status_reviewing');
      case 'sold':
        return l10n.t('status_sold');
      case 'listed':
        return l10n.t('status_listed');
      default:
        return status;
    }
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(controller: _title, decoration: InputDecoration(labelText: l10n.t('title_field'))),
            TextField(controller: _brand, decoration: InputDecoration(labelText: l10n.t('brand_field'))),
            TextField(controller: _year, decoration: InputDecoration(labelText: l10n.t('year_field')), keyboardType: TextInputType.number),
            TextField(controller: _notes, decoration: InputDecoration(labelText: l10n.t('tips'))),
            TextField(controller: _photo, decoration: InputDecoration(labelText: l10n.t('image_url'))),
            TextField(controller: _tips, decoration: InputDecoration(labelText: l10n.t('tips_placeholder'))),
            SwitchListTile(
