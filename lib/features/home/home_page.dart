    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (scope.coachMarksNotifier.shouldShow) {
        final overlay = CoachMarksOverlay(
          context: context,
          steps: [
            CoachMarkStep(key: _searchKey, title: AppLocalizations.of(context).t('tutorial_1'), message: 'Use smart filters and quick suggestions.'),
            CoachMarkStep(key: _heroKey, title: AppLocalizations.of(context).t('tutorial_2'), message: 'Drag horizontally to scrub through 3D frames.'),
            CoachMarkStep(key: _chipsKey, title: AppLocalizations.of(context).t('tutorial_3'), message: 'Tap chips to compare and filter instantly.'),
            CoachMarkStep(key: _compareKey, title: AppLocalizations.of(context).t('compare'), message: 'Compare tray keeps your picks ready.'),
            CoachMarkStep(key: _bookKey, title: AppLocalizations.of(context).t('tutorial_4'), message: 'Book visits without leaving the app.'),
          ],
          onComplete: () {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text('Modern Capsules', style: Theme.of(context).textTheme.titleLarge),
            ...
            const SizedBox(height: 24),
            Text('Cityscape Collection', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 12),
            SizedBox(
              height: 180,
              child: ListView.separated(
      ...
      bottomNavigationBar: AnimatedBuilder(
        ...
        builder: (context, child) {
          return CompareTray(
            key: _compareKey,
            items: scope.compareNotifier.ids,
