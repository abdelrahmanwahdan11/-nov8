...
class _BookingPageState extends State<BookingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedSummary = '${materialLocalizations.formatMediumDate(booking.selectedDate)}'
        '${booking.selectedSlot != null ? ' • ${booking.selectedSlot}' : ''}';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(_weekday(context, day), style: TextStyle(color: isSelected ? Colors.white70 : Colors.grey, fontSize: 12)),
                        ],
                      ),
                    ),
                  );
            ...
            AnimatedSwitcher(
              duration: const Duration(milliseconds: 250),
              child: booking.selectedSlot == null
                  ? const SizedBox.shrink()
                  : Padding(
                      key: ValueKey(booking.selectedSlot),
                      padding: const EdgeInsets.only(bottom: 12),
                      child: Text('${l10n.t('book_summary')}: $selectedSummary'),
                    ),
            ),
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: booking.selectedSlot == null
                    ? null
                    : () {
                        final message = '${l10n.t('confirm_booking')} · $selectedSummary';
